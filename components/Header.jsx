...
const Header = ({ setActiveComponent, activeNetwork }) => {
  ...
  // MENU LIST
  const navMenu = [
    'Home', 'Liquidity', 'Pool History', 'Liquidity History',
    'Networks',
  ]
    ...
    <div className="container">
      <nav className="">
        ...
        <Link href="/" className="logo">
          <Image src={`/assets/images/logo.png`} alt="webAI" className="h-10" width={150} height={50} />
        </Link>

        <div className="lg:hidden flex items-center ms-auto px-2 5">
          <button type="button" id="hs-unstyled-collapse" data-hs-collapse="#mobileMenu"  data-hs-type="collapse" className="hs-collapse-toggle inline-flex items-center justify-center h-9 w-12 rounded-md border border-white/20 bg-default-100/5">
            <CgMenuRight />
          </button>
        </div>
